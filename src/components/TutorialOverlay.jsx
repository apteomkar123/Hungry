...
const STEPS = [
  ...
  },
  {
    ...
    scrollTop: true,
    lines: [
      'Tap the 🔔 bell icon in the top-right header to see items expiring within 7 days.',
      'A red badge shows the count — expired items appear in red, expiring-soon in orange.',
      'Tap "Use 1" to mark an item as used. If it\'s the last one, it\'s removed from your pantry automatically.',
    ],
  },
  {
  ...
  },
  {
    ...
    scrollTop: true,
    lines: [
      'See an amber "Use Before It Expires" section at the top of the Recipe Explorer.',
      'It shows recipes that use items expiring in the next 7 days — nothing goes to waste.',
      'Items closer to expiry appear first so you always know what to cook next.',
    ],
  },
  {
    title: 'AI Expiry Coach',
    tab: 'pantry',
    emoji: '🤖',
    selector: '#tut-pantry',
    scrollTop: true,
    lines: [
      'When 3+ pantry items expire within 2 days, the bell panel shows an AI Expiry Coach.',
      'Tap "Generate Recipe" to get a recipe that uses up all those expiring items.',
      'Edit any item\'s expiry date inline from the notification panel with the pencil icon.',
    ],
  },
  {
    title: 'Pantry Search & Pins',
    tab: 'pantry',
    emoji: '📌',
    selector: '#tut-pantry',
    scrollTop: true,
    lines: [
      'Search your pantry with the filter bar at the top of your stock — items filter live.',
      'Inside any category, tap 📌 on an item to pin it to the top for quick access.',
      'Look for the "Eat Me First!" badge — the soonest-expiring item in each category.',
    ],
  },
  {
    ...
    scrollTop: true,
    lines: [
      'Type an item and tap ✨ (sparkles) to get an AI quantity suggestion — "2 lbs", "1 dozen".',
      'Accept the suggestion with "Add" or dismiss it. It prepends to your item name.',
      'Shopping history tracks the last date and count you bought each item.',
    ],
  },
  {
    title: 'Recipe Feedback & Cost',
    tab: 'recipes',
    emoji: '👍',
    selector: '#tut-recipes',
    scrollTop: true,
    lines: [
      'Tap 👍 or 👎 in any recipe to give feedback — helps you track what you liked.',
      'If your pantry items have prices, the Meal Cost Estimator shows cost per serving.',
      'AI Recipe Generator now produces 3 distinct recipes — pick the one that inspires you.',
    ],
  },
  {
    title: 'Household Pantry Audit',
    tab: 'household',
    emoji: '🗃️',
    selector: '#tut-household',
    scrollTop: true,
    lines: [
      'The Household tab shows a Pantry Audit: items that have been sitting longest.',
      'Items older than 30 days are flagged in red — a gentle nudge to use them up.',
      'Recipes saved by any household member now sync to everyone instantly.',
    ],
  },
];
