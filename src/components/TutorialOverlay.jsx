...
const STEPS = [
  ...
  },
  {
    ...
    lines: [
      ...
      'Green and amber dots show exactly which ingredients you have. No more "oops, I\'m out of eggs."',
  ...
  },
  {
    ...
    lines: [
      ...
      'Swipe items between your personal list and a shared household list.',
    ],
  },
  {
  ...
  {
    title: 'Potluck & Events',
    tab: 'potluck',
    emoji: '🎉',
    lines: [
      'Create an event (Friday BBQ, Potluck…) and share its unique invite code.',
      'Anyone with the link can join and claim items — Buns ✓, Ice ✓, Salad ✓.',
      'The readiness progress bar fills in real-time as friends claim their contributions.',
    ],
  },
  {
