...
-- ════════════════════════════════════════════════════════════
--  STEP 1: Create tables (no cross-referencing RLS yet)
-- ════════════════════════════════════════════════════════════
...
-- ── profiles ─────────────────────────────────────────────────
-- Must be created BEFORE households RLS policies are added
-- (profiles.active_household_id references households)
...
-- ════════════════════════════════════════════════════════════
--  STEP 3: RLS policies (all tables now exist)
-- ════════════════════════════════════════════════════════════

-- households policies
-- (profiles exists now, so active_household_id subquery works)
